...
public class Postagem {
	...
	@Size(min = 5,max = 100,message = "Este atributo precisa ter no mínimo 5 caracteres, e no máximo 100 caracteres")
	private String titulo;
	
	@NotBlank(message = "Este atributo é de preenchimento obrigatório")
	@Size(min = 10, max = 1000,message = "Este atributo precisa ter no mínimo 10 caracteres e no máximo 1000 caracteres")
